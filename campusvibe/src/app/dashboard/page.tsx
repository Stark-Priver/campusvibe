      ...
      <section className="bg-[#ECECEC] py-8 sm:py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-5">
            <DashboardSidebar
              title="Your Dashboard Actions"
              description={`Assigned roles: ${currentUser.roles.length}. Open the workspace that matches your current operations.`}
              links={availableRoles.map((role) => ({
                label: `Open ${role.roleName}`,
