...
extension SyncQueueItemQuerySortBy
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterSortBy> sortByRecordType() {
    return QueryBuilder.apply(this, (query) {
...
extension SyncQueueItemQuerySortThenBy
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterSortBy> thenByRecordType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'recordType', Sort.asc);
    });
  }
...
extension SyncQueueItemQueryWhereDistinct
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QDistinct> distinctByRecordType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SyncQueueItemQueryProperty
  ...
  QueryBuilder<SyncQueueItem, int, QQueryOperations> recordIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'recordId');
    });
  }

  QueryBuilder<SyncQueueItem, String, QQueryOperations> recordTypeProperty() {
    return QueryBuilder.apply(this, (query) {
